...
#define BLYNK_AUTH_TOKEN "PEurYIvfUO-suwoYGTNzvLJl4mW8YLNj"            //copy from Blynk console
...
char 
auth[] = "PEurYIvfUO-suwoYGTNzvLJl4mW8YLNj";   //   USER PARAMETER - Input Blynk Authentication Token (From Blynk console)
...
electricalPrice         = 10.5000;      //   USER PARAMETER - Input electrical price per kWh (Dollar/kWh,Euro/kWh,Peso/kWh)
